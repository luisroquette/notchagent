...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/version-v3.4.1-38D6C7?style=flat-square" alt="Version v3.4.1" /></a>
...
**Current version: 3.4.1** · Beta 1 · Model mascots + Desk hour progress · released 2026-08-18 · [version history](CHANGELOG.md)
...
> The notarized DMG below is still the 3.1.2 build. The current 3.4.1 ships
...
**Or download the signed ZIP** from [v3.4.1](../../releases/tag/v3.4.1), unzip it,
...
The 3.4.1 ZIP is signed with a local Apple Development identity (not
